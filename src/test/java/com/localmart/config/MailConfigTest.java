...
class MailConfigTest {
    ...
    void shouldUseConfiguredMailProperties() {
        contextRunner.withPropertyValues(
            ...
            assertThat(context).hasSingleBean(JavaMailSender.class);
            JavaMailSenderImpl sender = context.getBean(JavaMailSender.class).unwrap(JavaMailSenderImpl.class);
            ...
            assertThat(context.getBean(MailProperties.class).getFrom()).isEqualTo("alerts@example.com");
        });
    }
}
